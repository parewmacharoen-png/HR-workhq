...
export function formatMorningReport(payload: MorningBriefPayload, companyName: string): string {
  return [
...
export function formatEveningReport(payload: EveningBriefPayload, companyName: string): string {
  return [
